 ...
 * @brief Header of PT2PT MPMC Buffered Channel
 * @version 0.1
 * @date 2021-04-26
 * 
...
/**
 * @brief Allocates and initializes a MPI_Channel of type PT2PT MPMC buffered and returns a pointer to it
 * 
 ...
 * @param[in] comm Communicator of processes. Since channel is mpmc size of comm should be greater than 2
...
/**
 * @brief Sends the numbers of bytes specified in channel_alloc_pt2pt_mpmc_buf from the passed memory pointer data to the passed channel. A call to
 ...
 *        room again.
 * 
 * @param[in] ch Pointer to a MPI_Channel allocated with channel_alloc_pt2pt_mpmc_buf                 
 ...
 * 
 * @param[in, out] ch Pointer to a MPI_Channel allocated with channel_alloc_pt2pt_mpmc_buf       
 * 
