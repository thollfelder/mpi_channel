 ...
 * @copyright CC BY 4.0
 * 
 * RMA MPMC synchronous channels are used between multiple sender processes and multiple receiver processes where a synchronization
 ...
 * 
 * @param[in] ch Pointer to a RMA MPMC SYNC MPI_Channel                 
 ...
 * 
 * @param[in, out] ch Pointer to a RMA MPMC SYNC MPI_Channel   
 *                 
