...
#define BUFFER_TYPE PT2PT_SPSC_SYNCHRONIZED

#define PT2PT_SPSC_SYNCHRONIZED_S 0
#define PT2PT_SPSC_SYNCHRONIZED_M 1
...
double throughput(int len, int mode)
{
    ...
    if (mode == PT2PT_SPSC_SYNCHRONIZED_S)
    {
    ...
    if (mode == PT2PT_SPSC_SYNCHRONIZED_M)
    {
...
int main(int argc, char *argv[])
{
    ...
    char *channel_type = "PT2PT SPSC SYNCHRONIZED";
    ...
    test_case(PT2PT_SPSC_SYNCHRONIZED_M);
    ...
    test_case(PT2PT_SPSC_SYNCHRONIZED_S);
