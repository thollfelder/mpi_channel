...
// Needs to start at 2 because len/2 would yiel 0 in send/receive_multiple()
#define INT_START 2
#define INT_END 1000000

#define CHANNEL_TYPE RMA_SPSC_UNSYNCHRONIZED_BUFFERED

#define RMA_SPSC_UNSYNCHRONIZED_BUFFERED_S 0
#define RMA_SPSC_UNSYNCHRONIZED_BUFFERED_M 1
#define RMA_SPSC_UNSYNCHRONIZED_BUFFERED_SM 2
...
double throughput(int len, int mode)
{
    ...
    ////////////////////////////////////
    // RMA SPSC UNSYNC BUFFERED SINGLE SEND/RECEIVE
    if (mode == RMA_SPSC_UNSYNCHRONIZED_BUFFERED_S)
    {
...
int main(int argc, char *argv[])
{
    ...
    test_case(RMA_SPSC_UNSYNCHRONIZED_BUFFERED_S);
